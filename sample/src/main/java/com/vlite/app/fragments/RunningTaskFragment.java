...
import com.vlite.app.adapters.RunningTaskCardAdapter;
import com.vlite.app.bean.RunningInfo;
import com.vlite.app.databinding.FragmentRunningTaskBinding;
import com.vlite.app.helper.SimpleItemTouchCallback;
import com.vlite.app.helper.ItemTouchStatus;
import com.vlite.app.helper.ScrollSmoothHelper;
    ...
    private void bindRunningTaskViews(List<RunningInfo> result) {
        ...
        final SimpleItemTouchCallback itemTouchCallback = new SimpleItemTouchCallback(new ItemTouchStatus() {
            ...
            public boolean onItemRemove(int position) {
                ...
                VLite.get().killApplication(item.getPackageName());
